...
def randomforest(train_x, train_y, test_x, test_y):
	...
	print "Train Precision :: ", precision_score(train_y, trained_model.predict(train_x))
	print "Test Precision  :: ", precision_score(test_y, predictions)
	
        print "Train Recall :: ", recall_score(train_y, trained_model.predict(train_x))
...
def svm(XTrain, YTrain, XTest, YTest):
	...
	print("precision on training data: {}".format(svc.score(XTrain, YTrain)))
	print("precision on test data: {}".format(svc.score(XTest, YTest)))
	
        print("recall on training data: {}".format(svc.score(XTrain, YTrain)))
	print("recall on test data: {}".format(svc.score(XTest, YTest)))
...
def tfidf():
	f=open("../data/normalnews.json","r")
	Y=[]
	lines=[line for line in f] 
	titles=[json.loads(line)['title'] for line in lines] 

	f=open("../data/weirdnews.json","r")
